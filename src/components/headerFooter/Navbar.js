          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            <div className="relative flex h-16 items-center justify-between">
              ...
              {authUser && (
                <>
                  {/* Favorite Lists */}
                  <div className="hidden  mx-4 lg:flex justify-center items-center mt-1">
                    <Link href="/bookmarked_posts" legacyBehavior>
                      <MdBookmark className="h-8 w-8 text-gray-800 cursor-pointer " />
                    </Link>
                  </div>
                  ...
                  <div>
                    {authUser ? (
                      <>
                        ...
                        >
                          <img
                            className="h-9 w-9 rounded-full bg-red-400 border-2 border-gray-900"
                            src={
                              profileUrl
                                ? profileUrl
                                : "https://res.cloudinary.com/dltfhwsui/image/upload/v1665376261/Avatar_nvh0hb.png"
                            }
                            alt=""
                          />
                        </button>
                            ...
                            <a
                              className={
                                router.pathname == "/auth/login"
                                  ? "bg-gray-900 text-white px-3 py-2 rounded-lg text-base font-medium shadow-sm"
                                  : "text-gray-900 hover:bg-gray-900 hover:text-white hover:shadow-md px-3 py-2 rounded-lg text-base font-medium shadow-sm ease-in-out duration-150"
                              }
                            >
                              Log in
                            </a>
